    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(20.w, 20.0.w, 35.w, 0.0.w),
            child: Container(
              height: 400.w,
              width: 500.w,
              decoration: BoxDecoration(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    profileRow("Contact", pro.pContact, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("BMDC REG", pro.pBmdcReg, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Nid Num", pro.pNid, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Day", pro.pDay, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Designation", pro.pDesignation, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Specialization", pro.pSpecialization, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Fee", pro.pFee, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Location", pro.pLocation, context),
                    Divider(
                      thickness: 1.w,
                    ),
                    profileRow("Time", pro.pTime, context),
                  ],
                ),
              ),
            ),
